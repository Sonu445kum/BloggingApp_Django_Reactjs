    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('author', 'Author'), ('editor', 'Editor'), ('admin', 'Admin')], default='author', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookmarks', models.ManyToManyField(blank=True, related_name='bookmarked_by', to='blog.blog')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('like', 'Like'), ('love', 'Love'), ('wow', 'Wow')], max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
